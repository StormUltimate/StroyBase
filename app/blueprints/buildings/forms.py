...
class EquipmentForm(FlaskForm):
    ...
    parent_id = SelectField(
        "Родительское оборудование", coerce=int, validators=[Optional()]
    )
    ...
    last_service_date = DateField(
        "Дата последнего обслуживания", validators=[Optional()]
    )
    next_service_date = DateField(
        "Дата следующего обслуживания", validators=[Optional()]
    )
